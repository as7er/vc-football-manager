...
const dict = {
  zh: {
    ...
    "top.season": "赛季 {n}",
    "top.day": "第 {n} 天",
    "search.open": "搜索球员和俱乐部",
    "search.title": "全局搜索",
    "search.placeholder": "输入球员或俱乐部名称",
    "search.hint": "输入至少 2 个字符",
    "search.empty": "没有匹配的球员或俱乐部",
    "search.players": "球员",
    "search.clubs": "俱乐部",
    "search.youth": "本队青训",
  ...
  en: {
    ...
    "top.season": "Season {n}",
    "top.day": "Day {n}",
    "search.open": "Search players and clubs",
    "search.title": "Global search",
    "search.placeholder": "Enter a player or club name",
    "search.hint": "Enter at least 2 characters",
    "search.empty": "No matching players or clubs",
